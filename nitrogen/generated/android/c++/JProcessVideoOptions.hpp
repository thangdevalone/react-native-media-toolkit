...
namespace margelo::nitro::mediatoolkit {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "ProcessVideoOptions" and the the Kotlin data class "ProcessVideoOptions".
   */
  struct JProcessVideoOptions final: public jni::JavaClass<JProcessVideoOptions> {
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/com/mediatoolkit/ProcessVideoOptions;";

  public:
    /**
     * Convert this Java/Kotlin-based struct to the C++ struct ProcessVideoOptions by copying all values to C++.
     */
    [[maybe_unused]]
    [[nodiscard]]
    ProcessVideoOptions toCpp() const {
      ...
      static const auto fieldEndTime = clazz->getField<jni::JDouble>("endTime");
      jni::local_ref<jni::JDouble> endTime = this->getFieldValue(fieldEndTime);
      ...
      return ProcessVideoOptions(
        ...
        endTime != nullptr ? std::make_optional(endTime->value()) : std::nullopt,
  ...
  public:
    ...
    static jni::local_ref<JProcessVideoOptions::javaobject> fromCpp(const ProcessVideoOptions& value) {
      ...
      return create(
        ...
        value.endTime.has_value() ? jni::JDouble::valueOf(value.endTime.value()) : nullptr,
