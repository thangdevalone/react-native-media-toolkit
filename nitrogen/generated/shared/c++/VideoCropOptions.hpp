...
namespace margelo::nitro::mediatoolkit {
  ...
  /**
   * A struct which can be represented as a JavaScript object (VideoCropOptions).
   */
  struct VideoCropOptions final {
  public:
  ...
  public:
    VideoCropOptions() = default;
    explicit VideoCropOptions(double x, double y, double width, double height, std::optional<std::string> outputPath): x(x), y(y), width(width), height(height), outputPath(outputPath) {}

  public:
    friend bool operator==(const VideoCropOptions& lhs, const VideoCropOptions& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ VideoCropOptions <> JS VideoCropOptions (object)
  template <>
  struct JSIConverter<margelo::nitro::mediatoolkit::VideoCropOptions> final {
    static inline margelo::nitro::mediatoolkit::VideoCropOptions fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::mediatoolkit::VideoCropOptions(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::mediatoolkit::VideoCropOptions& arg) {
